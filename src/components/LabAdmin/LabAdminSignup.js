...
function LabAdminSignup(props) {

  if (reactLocalStorage.get('token')){
      props.history.push("/labAdmin");
  }
  ...
  const handleSubmit = async (e) => {
    ...
    if (formdata.position.lat === "" || formdata.position.lng === "") {
      ...
      await axios
      .post("http://localhost:5000/lab-admin/signup",fd,{
          headers: {
